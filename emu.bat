...
set SEND="C:\Users\schol\Documents\MEGA65\m65tools-develo-180-a2da95-windows\mega65_ftp.exe" -l COM7 -c "put DEMO.D81" -c "mount PLAT.D81" -c "quit" 
